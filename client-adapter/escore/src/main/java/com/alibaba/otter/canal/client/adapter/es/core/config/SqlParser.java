...
public class SqlParser {
    ...
    public static void main(String[] args) {
        parse("select a.id,a.enterprise_id,a.create_user_id,a.mail_subject,mail_from,mail_send_date,mail_to,recipients_cc,recipients_bcc,mail_box_type_id,mail_read_flag,mail_delete_flag,customer_enterprise_ids,mail_star_flag,mail_to_do_flag,mail_attachment_flag,account_id,mail_answered_flag,from_or_to_flag,mail_success_flag,mail_group_sending_single_show_flag,mail_open_times,mail_crm_flag,reciever_crm_flag,IFNULL(c.labelids,'') AS labelids from mail_box a " +
                "LEFT JOIN (" +
                "select mail_box_id, group_concat(mail_label_id order by id desc separator ';') AS labelids from mail_box_label_relation group by mail_box_id) as c " +
                "on c.mail_box_id = a.id");
